...
// document.querySelector('.btn-number').click(function(e){
//     e.preventDefault();
...
// document.querySelector('.input-number').focusin(function(){
//    this.setAttribute('oldValue', this.value);
// });

// document.querySelector('.input-number').change(function() {

//     minValue =  parseInt(this.getAttribute('min'));
//     maxValue =  parseInt(this.getAttribute('max'));
//     valueCurrent = parseInt(this.value);
...
//     } else {
//         alert('Sorry, the minimum value was reached');
//         this.value(this.setAttribute('oldValue'));
//     }
//     if(valueCurrent <= maxValue) {
